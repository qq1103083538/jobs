...
class User(models.Model):
    ...
    用户model
    """
    username = models.CharField(max_length=16, verbose_name=u"用户名", unique=True)
    ...
    status = models.IntegerField(choices=((1, u"有效"), (0, u"无效")), default=1, verbose_name=u"是否是有效用户")
...
class Edu(models.Model):
    ...
    graduate_start_time = models.DateTimeField(default=datetime.now, verbose_name=u"开始时间")
    graduate_end_time = models.DateTimeField(default=datetime.now, verbose_name=u"结束时间")
    major = models.CharField(max_length=16, verbose_name=u"专业")
    major = models.CharField(max_length=16, verbose_name=u"专业")
    colleges = models.CharField(max_length=16, verbose_name=u"院校")
    education = models.CharField(max_length=100, choices=(), default=u"", verbose_name=u"学历")
    degree = models.CharField(max_length=100, choices=(), default=u"", verbose_name=u"学位")
...
class Professional(models.Model):
    ...
    level = models.IntegerField(verbose_name=u"等级", choices=((1, "初级"), (2, "中级(中级技师)"), (3, "高级(高级技师)")), default=1)
...
class UserInfo(models.Model):
    ...
    个人信息model
    """
    username = models.ForeignKey(User, on_delete=models.CASCADE, verbose_name=u"账号")
    photo = models.ImageField(upload_to="image/%Y/%m", default=u"image/default.png", max_length=100)
    ...
    political_landscape = models.CharField(max_length=20, default=u"群众", verbose_name=u"政治面貌")
    native_place = models.CharField(max_length=20, default=u"", verbose_name=u"籍贯")
    work_units = models.CharField(max_length=100, default=u"", verbose_name=u"工作单位")
    department = models.CharField(max_length=100, default=u"", verbose_name=u"所在部门")
...
class EducationInfo(models.Model):
    ...
    """
    username = models.ForeignKey(User, on_delete=models.CASCADE, verbose_name=u"账号")
    graduate_school = models.CharField(max_length=200, default=u"", verbose_name=u"毕业院校")
    graduate_time = models.DateTimeField(default=datetime.now, verbose_name=u"毕业院校")
    education_type = models.CharField(max_length=100, choices=(), default=u"", verbose_name=u"受教育类型")
    degree = models.CharField(max_length=100, choices=(), default=u"", verbose_name=u"学位")
    education = models.CharField(max_length=100, choices=(), default=u"", verbose_name=u"学历")
    institutions = models.CharField(max_length=100, choices=(), default=u"", verbose_name=u"院校")
    professional = models.CharField(max_length=100, choices=(), default=u"", verbose_name=u"专业")
    work_experience = models.CharField(max_length=100, choices=(), default=u"", verbose_name=u"海外工作/学习经历")
...
class MajorClass(models.Model):
    ...
    status = models.IntegerField(choices=((1, u"有效"), (0, u"无效")), default=1, verbose_name=u"状态 1：有效 0：无效")
...
class MajorFirst(models.Model):
    major_class = models.ForeignKey(MajorClass, verbose_name=u"类别", on_delete=models.CASCADE)
...
class MajorSecond(models.Model):
    major_first = models.ForeignKey(MajorFirst, verbose_name=u"一级专业", on_delete=models.CASCADE)
